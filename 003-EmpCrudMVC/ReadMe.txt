...
Doing so makes use of Spring Framework�s Servlet 3.0 support and lets you configure your application when it is launched by the servlet container. Typically, you should update your application�s main class to extend SpringBootServletInitializer
